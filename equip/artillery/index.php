  ...
  <table border=1; align=center>
    ...
    <tbody>
      <?php
        ...
        $query = $db->query('select * from artillery');
      ...
      ?>
          ...
          <tr>
            ...
            <td><a href="show.php?id=<?php print $post->id; ?>">适用舰种</a></td>
            <td><a href="show.php?id=<?php print $post->id; ?>">射速</a></td>
    ...
    <img alt="warship-LOGO" src="../../uploads/jp-1.jpg" width="356px" height="256px">
